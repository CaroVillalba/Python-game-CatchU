...
fuenteGrande = pygame.font.Font(r"assets\fonts\Pokemon GB.ttf", 40)
fuenteMed = pygame.font.Font(r"assets\fonts\Pokemon GB.ttf", 20) #defino la variable de fuente para no estar escribiendola a cada rato
fuenteChik =  pygame.font.Font(r"assets\fonts\Pokemon GB.ttf", 15)                                         #tiene tamanio y el tipo de fuente 
def dibujaTexto(texto, fuente, colorTexto, x, y):#para dibujar texto
...
#-------------------------------Jugador (declaraciones y correciones de formato)-------------------------------------------------

jugador = pygame.Rect(296, 500, 120, 120) #ubicacion y tamanio del pj
ImagenJugador = pygame.image.load(r"assets\images\mejorado3.png")
ImagenScaleJuga = pygame.transform.scale(ImagenJugador, (120, 120))



ImgBomba = pygame.image.load(r"assets\images\bombamejorada.png")
ImgBomba = pygame.transform.scale(ImgBomba, (80, 80))

ImgManzana = pygame.image.load(r"assets\images\manzana.png")
ImgManzana = pygame.transform.scale(ImgManzana, (45, 45))

ImgCometa = pygame.image.load(r"assets\images\cometa.png")
ImgCometa = pygame.transform.scale(ImgCometa, (80,80))

ImgFuego = pygame.image.load(r"assets\images\fuego.png")
...
bJ=pygame.image.load(r"assets\images\jugar tranqui.png")
bJM=pygame.image.load(r"assets\images\jugar_fuego.png")
bS=pygame.image.load(r"assets\images\salir.png")
bSM=pygame.image.load(r"assets\images\salir1.png")
bV=pygame.image.load(r"assets\images\voler.png")
bVM=pygame.image.load(r"assets\images\volver azul.png")


#fondos

menuprincipal = pygame.image.load(r"assets\images\menu principal.png")#defino y acomodo la imagen del fondo
menuprincipal = pygame.transform.scale(menuprincipal, (ANCHOVENTANA, ALTOVENTANA))
Fondo = pygame.image.load(r"assets\images\fondo_estado0.jpg")
FondoCambioEstado_1 = pygame.image.load(r"assets\images\car1.jpeg")
FondoCambioEstado_1 = pygame.transform.scale(FondoCambioEstado_1, (ANCHOVENTANA, ALTOVENTANA))
FondoCambioEstado_2 = pygame.image.load(r"assets\images\Ftarde.png")
FondoCambioEstado_2 = pygame.transform.scale(FondoCambioEstado_2, (ANCHOVENTANA, ALTOVENTANA))
FondoCambioEstado_3 = pygame.image.load(r"assets\images\car3.jpeg")
FondoCambioEstado_3 = pygame.transform.scale(FondoCambioEstado_3, (ANCHOVENTANA, ALTOVENTANA))
FondoGameOver = pygame.image.load(r"assets\images\game_over_imagen1.png")
FondoGameOver = pygame.transform.scale(FondoGameOver, (ANCHOVENTANA, ALTOVENTANA))

#sonido

sonido_agarra_moneda = pygame.mixer.Sound(r"assets\sounds\sonido_de_puntos_adaptando.wav")
sonido_toca_bomba = pygame.mixer.Sound(r"assets\sounds\gameboy-pluck-41265-from-pixabay.mp3")
...
def musica_fondo(flagMusica):#Funcion de cambio de musica
    if flagMusica == 0:
        pygame.mixer.music.load(r"assets\sounds\bit-beats-6-171021-by-XtremeFreddy.mp3")
        pygame.mixer.music.play(-1)
        pygame.mixer.music.set_volume(0.2)
    elif flagMusica == 1:
        pygame.mixer.music.load(r"assets\sounds\music-for-arcade-style-game-146875-by-lucadialessandro.mp3")
        pygame.mixer.music.play(-1)
        pygame.mixer.music.set_volume(0.2)

class Cpinguino(pygame.sprite.Sprite):# personaje
    def __init__(self, x, y):
        self.sheet = pygame.image.load(r"assets\images\pinguino-animado.png")
...
class Cfrutas(object):
    ...
    def draw(self, superficieVentana):
        if self.f_type == 0:
            ImagenFruta = pygame.image.load(r"assets\images\banana.png")
            self.vel = 16
...
#--------------------------------------------------------------------------------------------------
            ...
            if gameOver == False:
                ...
                for item in bombas[:]:
                    if pygame.Rect(pinguinito.hitbox).colliderect(item.hitbox):        
                        ...
                        lifeUp-=1
                        if(lifeUp<0):
                            gameOver = True #termina el juego si toca una bomba el hitbox del pinguino
        ...
        #-------------------------------------------------FIn ciclo del Juego---------------------------------------------
        pygame.display.flip()
        reloj.tick(45) #define los fps de las imagenes por pantalla -> velocidad de las imagenes
main()